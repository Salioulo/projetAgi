 ...
 */
final class Version20190412110007 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande ADD libelle_materiel VARCHAR(255) DEFAULT NULL, ADD marque VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL, CHANGE description description_probleme VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE demande DROP libelle_materiel, DROP marque, CHANGE email email VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE description_probleme description VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
