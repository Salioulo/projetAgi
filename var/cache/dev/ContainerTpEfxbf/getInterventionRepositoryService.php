...
// Returns the private 'App\Repository\InterventionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\InterventionRepository.php';

return $this->privates['App\Repository\InterventionRepository'] = new \App\Repository\InterventionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
