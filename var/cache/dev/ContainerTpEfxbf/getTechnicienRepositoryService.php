...
// Returns the private 'App\Repository\TechnicienRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TechnicienRepository.php';

return $this->privates['App\Repository\TechnicienRepository'] = new \App\Repository\TechnicienRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
